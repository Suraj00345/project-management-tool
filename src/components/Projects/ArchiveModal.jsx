...
const ArchiveModal = ({ isOpen, setIsOpen, projectId, onArchive }) => {
  ...
  const archiveHandler = async () => {
    ...
    try {
      ...
      toast.error(error.message || "Error archiving project");
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto backdrop:blur-md ">
        <div className="flex min-h-full items-center justify-center p-4">
          ...
          >
            ...
            <p className="mt-2 text-sm/6 text-gray-600">Are you sure you want to archive this project? You can change your mind later.</p>
