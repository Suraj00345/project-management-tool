...
import { deleteTaskApi } from "../../utils/api-client";

const CardDeleteModal = ({ isOpen, onClose, cardId, onDelete }) => {
  ...
  const deleteHandler = async () => {
    ...
    try {
      ...
      if (!res) throw new Error("Task deletion failed");
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto backdrop:blur-md ">
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              ...
              <p className="mt-2 text-sm/6 text-gray-600">Are you sure you want to delete this task? This action cannot be undone.</p>
